...
$stmt = $pdo->prepare("INSERT INTO bookings (activity_id, booking_date, booking_time, user_id) VALUES (:activity_id, :booking_date, :booking_time, :user_id)");
$stmt->execute(['activity_id' => $activityId,'booking_date' => $bookingDate,'booking_time' => $bookingTime,'user_id' => $userId]);
